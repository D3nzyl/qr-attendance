...
const empKey = (emp) => getNric(emp) || getName(emp) || emp._original || String(emp.id);

export default function WeeklyReport({ weekData, monday, headerData }) {
  ...
  const empMap = {}; // key → { nric, empId, name, days: { DAY: { temperature, fit, signature } } }
  DAYS.forEach(day => {
  ...
  const fmtDate = (d) => d.toLocaleDateString('en-SG', { day: '2-digit', month: 'short', year: '2-digit' });
  ...
  return (
    <div className="card report-card">
      ...
      <div className="report-body">
        ...
        {(() => {
          const allImages = DAYS.flatMap((day, i) =>
