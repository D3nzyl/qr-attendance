...
router.get('/weeks/:contract/:teamNo', (req, res) => {
...
router.put('/day/:contract/:teamNo/:weekKey/:day', (req, res) => {
...
router.delete('/day/:contract/:teamNo/:weekKey/:day', (req, res) => {
  const { contract, teamNo, weekKey, day } = req.params;
